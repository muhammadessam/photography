                    ...
                    <div class=" login-div login-div2">
                        <div class="">
                            <div class=" content-log">
                                ...
                                <div>
                                    <form action="<?php echo e(route('account.orders.store')); ?>" method="POST">
                                        <div class="row m-0 p-0">
...
<?php echo $__env->make('site.layouts.base', ['isAccount' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\photos\resources\views/site/account/orders/create.blade.php ENDPATH**/ ?>