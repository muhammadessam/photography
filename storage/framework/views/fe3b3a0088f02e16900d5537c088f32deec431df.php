...
<script src="<?php echo e(asset('admin/dist/js/lightgallery-all.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/dist/js/jquery.mousewheel.min.js')); ?>"></script>
<script type="text/javascript">
    $(document).ready(function(){
        $('#lightgallery').lightGallery();
    });
...
<?php /**PATH /home/abcconsttech/public_html/photography/resources/views/admin/layout/footer.blade.php ENDPATH**/ ?>