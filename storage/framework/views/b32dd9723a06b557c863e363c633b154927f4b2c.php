            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.employees.update',$employee)); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nationality" id="nationality" value="<?php echo e($employee->nationality); ?>">
                    </div>
                    <div class="form-group">
                        <label for="is_available">الحالة</label>
                        <select name="is_available" class="form-control" id="exp">
                            <option <?php echo e($employee->is_available ? 'selected' : ''); ?> value="1">نعم</option>
                            <option <?php echo e(!$employee->is_available ? 'selected' : ''); ?> value="0">لا</option>
                        </select>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abcconsttech/public_html/photography/resources/views/admin/employees/edit.blade.php ENDPATH**/ ?>