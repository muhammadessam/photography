        ...
        <div class="container-fluid">
            <div class="row mb-2 mt-5 justify-content-center">
                <div class="col-xl-3 col-md-6">
                    <!-- small box -->
                    <div class="">
                        <a href="<?php echo e(route('admin.bills.index')); ?>" class="small-box text-white  bg-success-gradient h-100  small-box   d-flex align-items-center d-block">
                            <div class="inner">
                                <h5> الفواتير المسددة</h5>
                                <h4 class="mt-4"><?php echo e(\App\Bill::all()->where('status', 'مسدد')->pluck('price')->sum()); ?></h4>
                            </div>
                            <div class="icon">
                ...
                <div class="col-xl-3 col-md-6">
                    <!-- small box -->
                    <div class="  ">
                        <a href="<?php echo e(route('admin.bills.index')); ?>" class="small-box  text-white bg-danger-gradient text-white bg-info-gradient  h-100  small-box   d-flex align-items-center d-block">
                            <div class="inner">
                                <h5> الفواتير الغير مسددة</h5>
                                <h4 class="mt-4"><?php echo e(\App\Bill::all()->where('status', 'غير مسدد')->pluck('price')->sum()); ?></h4>
                            </div>
                            <div class="icon">
                ...
                <div class="col-xl-3 col-md-6">
                    <!-- small box -->
                    <div class="small-box  ">
                        <a href="<?php echo e(route('admin.bills.index')); ?>" class=" text-white bg-info-gradient  h-100  small-box   d-flex align-items-center d-block">
                            <div class="inner">
                                <h5> الباقي في الفواتير</h5>
                                <h4 class="mt-4"><?php echo e(\App\Bill::all()->where('status', 'متبقي')->pluck('remains')->sum()); ?></h4>
                            </div>
                            <div class="icon">
    ...
    <div class="container pt-3">
        <div class="row ">
            ...
            <div class="col-md-4 col-lg-3  col-sm-6  animated bounceInDown">
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="d-block">
            ...
            <div class="col-md-4 col-lg-3  col-sm-6  animated bounceInUp">
                <a href="<?php echo e(route('admin.bills.index')); ?>">
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abcconsttech/public_html/photography/resources/views/admin/home.blade.php ENDPATH**/ ?>