...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('public/'.'webProject/icofont/css/icofont.min.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('public/'.'css/lightgallery.min.css')); ?>">
    ...
    <body>
        ...
        <script src="<?php echo e(asset('public/'.'js/lightgallery-all.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/'.'js/jquery.mousewheel.min.js')); ?>"></script>
...
<?php /**PATH /home/abcconsttech/public_html/photography/resources/views/site/layouts/base.blade.php ENDPATH**/ ?>
