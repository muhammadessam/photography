                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info-gradient h-100 d-flex align-items-center">
                        <div class="inner">
                            ...
                            <h6 class="mt-4"><?php echo e(\App\Bill::all()->where('status', 'مسدد')->pluck('price')->sum()); ?></h6>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success-gradient  h-100  d-flex align-items-center" >
                        <div class="inner">
                            ...
                            <h6 class="mt-4"><?php echo e(\App\Bill::all()->where('status', 'غير مسدد')->pluck('price')->sum()); ?></h6>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger-gradient  h-100   d-flex align-items-center">
                        <div class="inner">
                            ...
                            <h6 class="mt-4"><?php echo e(\App\Bill::all()->where('status', 'متبقي')->pluck('remains')->sum()); ?></h6>
                        </div>
                        <div class="icon">
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abcconsttech/public_html/photography/resources/views/admin/bills/index.blade.php ENDPATH**/ ?>