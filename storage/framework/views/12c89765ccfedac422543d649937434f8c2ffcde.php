                    ...
                    <?php $__currentLoopData = \App\Contact::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="row d-flex justify-content-around">
                                <div class=""><a title="مشاهدة" class="btn btn-info" href="<?php echo e(route('admin.contact.show', $item)); ?>"><i class="fa fa-eye"></i></a></div>
                                <div class=""><a title="رد" class="btn btn-primary" href="<?php echo e(route('admin.showReplyForm', $item)); ?>"><i class="fa fa-send"></i></a></div>
                                <div class="">
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abcconsttech/public_html/photography/resources/views/admin/contact/index.blade.php ENDPATH**/ ?>