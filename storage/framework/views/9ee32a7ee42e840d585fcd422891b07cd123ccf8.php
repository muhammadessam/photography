                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" style="text-align: right !important;">
                            <h3 class="card-title"><?php echo e($country->name); ?></h3>
                            <div class="card-tools">
                                <div>
                                    <form class="form-inline" action="<?php echo e(route('admin.city.store')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?> 
                        ...
                        <div class="card-body">
                            <table id="cats" class="table table-striped">
                                ...
                                <?php $__currentLoopData = $country->cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($item['name']); ?></td>
                                        <td class="d-flex">
                                            <a class="btn btn-primary ml-2" href="<?php echo e(route('admin.city.edit', $item)); ?>"><i class="fa fa-edit"></i></a>
                                            <form action="<?php echo e(route('admin.city.destroy', $item)); ?>" method="post" onsubmit="return confirm('هل انت متاكد ؟')">
...
<?php endif; ?> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\photos\resources\views/admin/countries/show.blade.php ENDPATH**/ ?>