                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="customer_id" id="customer_id">
                                                <?php $__currentLoopData = \App\Customer::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($order['customer_id']==$item['id'] ? 'selected':''); ?> value="<?php echo e($item['id']); ?>"><?php echo e($item->user->name); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cat_id" id="cat_id">
                                                <?php $__currentLoopData = \App\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($order['cat_id']==$item['id'] ? 'selected':''); ?> value="<?php echo e($item['id']); ?>"><?php echo e($item['name']); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                <option <?php echo e($order['status']=='waiting' ? 'selected':''); ?> value="waiting">انتظار</option>
                                                <option <?php echo e($order['status']=='accepted' ? 'selected':''); ?> value="accepted">تم القبول</option>
                                                <option <?php echo e($order['status']=='billed' ? 'selected':''); ?> value="billed">اصدار قاتورة غير مسددة</option>
                                                <option <?php echo e($order['status']=='final' ? 'selected':''); ?> value="final">القبول نهائيا</option>
                                                <option <?php echo e($order['status']=='rejected' ? 'selected':''); ?> value="rejected">مرفوضة</option>
                                            </select>
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" @change="changeCountry($event)" name="country_id" id="country_id">
                                                <?php if($order->country): ?>                                                    
                                                    <option value="<?php echo e($order->country->id); ?>"><?php echo e($order->country->name); ?></option>
                                                <?php endif; ?>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" name="city_id" id="city_id">
                                                <option value="<?php echo e($order->city->id); ?>"><?php echo e($order->city->name); ?></option>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="day" id="day">
                                                <option value="<?php echo e($order->day); ?>"><?php echo e($order->day); ?></option>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="address" id="address" value="<?php echo e($order['address']); ?>">
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="datetime-local" name="date" id="date" value="<?php echo e(\Carbon\Carbon::parse($order['date'])->format('Y-m-d\TH:i')); ?>">
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="is_special" id="is_special">
                                                <option    <?php echo e($order['is_special'] ? 'selected' : ''); ?>     value="1">خاصة</option>
                                                <option    <?php echo e(!$order['is_special'] ? 'selected' : ''); ?>    value="0">عامة</option>
                                            </select>
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="is_right_print" id="is_right_print">
                                                <option  <?php echo e($order['is_right_print'] ? 'selected' : ''); ?>  value="1">نعم</option>
                                                <option  <?php echo e(!$order['is_right_print'] ? 'selected' : ''); ?> value="0">لا</option>
                                            </select>
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="is_on_our_page" id="is_on_our_page">
                                                <option  <?php echo e($order['is_on_our_page'] ? 'selected' : ''); ?>  value="1">نعم</option>
                                                <option  <?php echo e(!$order['is_on_our_page'] ? 'selected' : ''); ?> value="0">لا</option>
                                            </select>
                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abcconsttech/public_html/photography/resources/views/admin/orders/edit.blade.php ENDPATH**/ ?>