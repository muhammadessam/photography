...
<section class="my-2 mt-4 register">
    <div class="container">
        ...
        <div class="dif">
            <h4 class="text-center font-weight-bold">مرحبا بك يا <span class="c-bol"><?php echo e(explode(' ', auth()->user()->name)[0]); ?></span></h4>
...
<?php echo $__env->make('site.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\photos\resources\views/site/account/index.blade.php ENDPATH**/ ?>