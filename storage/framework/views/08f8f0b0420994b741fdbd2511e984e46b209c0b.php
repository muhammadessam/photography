                    ...
                    <div class="my-2">
                        ...
                        <div class="d-flex">
                            <div class="acp-user-img">
                                <img class="w-100" src="<?php echo e($order->customer->user->image == null?'https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png':asset('public/'.$order->customer->user->image)); ?>" alt=" ">
                            </div>
                            <div class="acp-cln-u">
...
<?php echo $__env->make('site.layouts.base', ['isAccount' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abcconsttech/public_html/photography/resources/views/site/account/orders/show.blade.php ENDPATH**/ ?>
