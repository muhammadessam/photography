        ...
        <div class="card-body">
            <form action="{{route('admin.services.update', $service)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" value="{{$service->title}}" required class="form-control">
                </div>
                <div class="form-group">
                    <label for="description">وصف الخدمة</label>
                    <input type="text" id="description" value="{{$service->description}}" required name="description"class="form-control">
                </div>
                <div class="form-group">
                    <label for="icons">أيقونة</label>
                    <div class="d-flex align-items-center">
                        <div class="m-1">
                            <i class="fa fa-{{ $service->icon }}" data-icon="{{ $service->icon }}" id="icon-preview"></i>
                        </div>
