...
<section class="my-5 register">
    <div class="container pt-5">
      <div class="my-shadow py-4 mx-auto mt-5" style="max-width: 500px" >
        <div class="dif">
          <h4 class="text-center font-weight-bold">تغيير كلمة المرور</h4>
                  ...
                  <div class="mt-4">
                    ...
                    <form method="POST" action="{{ route('password.update') }}" >
                      <div class="row m-0 p-0">
                        ...
                        <div class="form-group col-md-12 ">
                            <div class="row w-100 m-0 p-0">
                              <div class="pr-0 col-sm-12 mb-2 invoice-label c-bol font-weight-bold ">اختر كلمة مرور جديدة:</div>
                        ...
                        <div class="form-group col-md-12 ">
                            <div class="row w-100 m-0 p-0">
                              ...
                              <div class="pl-0 col-sm-12 pr-0 "> <input type="password" name="password_confirmation" class="form-control" required></div>
                            </div>
                        </div>
                      </div>
                      <div class="col-12">
